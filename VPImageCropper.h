...
@class VPImageCropper;

@protocol VPImageCropperDelegate <NSObject>

- (void)imageCropper:(VPImageCropper *)cropperViewController didFinished:(UIImage *)editedImage;
- (void)imageCropperDidCancel:(VPImageCropper *)cropperViewController;

@end

@interface VPImageCropper : UIViewController
